...
from utility.facebook import is_facebook_login, get_facebook_url
    ...
    for item in read_json("source-02"):
        if not database.contains(Query().domain == item["site"]):
            ...
            for idp in item["idps"]:
                ...
                if get_facebook_url(idp.get("idp_landing_url", "")):
                    ...
                    domain["idps"] = [{
                        ...
                        "internal": internal,
                        "button": None,
                        "url": get_facebook_url(idp.get("idp_landing_url", ""))
                    }]
